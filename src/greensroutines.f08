...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    elemental function get_size(this)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                ...
                do k = 1, zsize
                    do l = 1, nomega
                        test_optional_variable: if (present(hybridisation)) then
                            ...
                            work = cmplx_zero
                        end if test_optional_variable

                        work = work + real(l**2, real12)*deltaw*deltaw &
                               - dispersion(i, j, k)%omega2

                        check_div_by_zero: if ((abs(real(work)) < tolerance) &
                                               .and. (abs(aimag(work)) < tolerance)) then
                            ierr = 1
                            return
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        if (nomega /= nomega1) then
            ierr = 2
            return
        elseif ((nfx <= ncx) .or. (nfy <= ncy) .or. (nfz <= ncz)) then
            ierr = 3
            return
        else
            continue
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ierr = 0
        check_div_by_zero: if ((any(abs(real(GF%GF)) < tolerance)) &
                               .and. (any(abs(aimag(GF%GF)) < tolerance))) then
            ierr = 1
            return
        end if check_div_by_zero
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ierror = 0
        ! test inputs
        if ((nx <= 0) .or. (ny <= 0) .or. (nz <= 0) .or. (nomega <= 0)) ierror = 1
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            if ((nx <= 0) .or. (ny <= 0) .or. (nz <= 0) .or. (nomega <= 0)) ierr = 1
